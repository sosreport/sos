...
Even if an AI assistant generates the code and the associated commit message,
and opens the PR autonomously, this project holds the human behind the contribution
wholly responsible for not just the content  of the contribution, but also for
meaningfully engaging with the review process and all other communication with the
project, its maintainers, and other contributors.
