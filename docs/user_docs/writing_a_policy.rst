...
variables are used as substitutions in the preamble message displayed
...
dynamically loaded by Sosreport to determine whether it should run on
the current distribution. This is usually done by checking the
...
superclasses. See :doc:`How to Write a Plugin <writing_a_plugin>`
