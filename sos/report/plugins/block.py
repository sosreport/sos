...
class Block(Plugin, IndependentPlugin):
    ...
    def setup(self):
        ...
        self.add_device_cmd(udevadm_cmds, devices='block', blacklist='ram.*', subdir=_subdir1)
        self.add_device_cmd(parted_cmds, devices='block', blacklist='ram.*', subdir=_subdir2)
        self.add_device_cmd("fdisk -l %(dev)s", blacklist="ram.*",
                            devices="block", tags="fdisk_l_sos", subdir=_subdir2)
